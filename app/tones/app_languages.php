...
$text['title-tones']['es-mx'] = "Tono"; //copied from es-cl
$text['title-tones']['fr-ca'] = "Ton"; //copied from fr-fr
...
$text['label-tone']['es-mx'] = "Tono"; //copied from es-cl
$text['label-tone']['fr-ca'] = "Ton"; //copied from fr-fr
