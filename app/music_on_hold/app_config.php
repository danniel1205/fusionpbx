...
//		$apps[$x]['description']['en-us'] = "Add, Delete, or Play Music on hold files.";
		$apps[$x]['description']['en-us'] = "添加、删除或播放保留音乐文件。";
		$apps[$x]['description']['zh-cn'] = "添加、删除或播放保留音乐文件。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "8000,16000,32000,48000";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "800016000320004808000";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "800016000320004808000";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "music_on_hold_shuffle";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "true/false";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "对/错";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "对/错";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "music_on_hold_channels";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "1-mono, 2-stereo";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "1-单声道，2-立体声";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "1-单声道，2-立体声";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "music_on_hold_interval";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "milliseconds";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "毫秒";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "毫秒";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "music_on_hold_timer_name";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "soft";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "软的";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "软的";
		$z++;
