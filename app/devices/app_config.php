...
//		$apps[$x]['description']['en-us'] = "Devices for provisioning.";
		$apps[$x]['description']['en-us'] = "用于设置的设备。";
		$apps[$x]['description']['zh-cn'] = "用于设置的设备。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the line number.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择行号。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择行号。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "server_address";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the sip server address.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入SIP服务器地址。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入SIP服务器地址。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the outbound proxy.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入出站代理。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入出站代理。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the display name.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入显示名称。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入显示名称。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "user_id";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the user id.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入用户ID。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入用户ID。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "auth_id";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the auth ID.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入身份验证ID。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入身份验证ID。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the key ID.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择密钥ID。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择密钥ID。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "device_key_category";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the type.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择类型。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the vendor.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入供应商。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入供应商。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select whether to protect this key from the user group.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择是否保护此密钥不受用户组的影响。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择是否保护此密钥不受用户组的影响。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "device_key_label";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the label.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入标签";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "ICON Name.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "ICON 名字";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "ICON 名字";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Set the status of the vendor.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "设置供应商的状态。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "设置供应商的状态。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Set the status of the function.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "设置函数的状态。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "设置函数的状态。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "description";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the description.";
