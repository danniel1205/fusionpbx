...
//		$apps[$x]['description']['en-us'] = "Manager voicemail greetings for extensions.";
		$apps[$x]['description']['en-us'] = "经理语音信箱分机问候语。";
		$apps[$x]['description']['zh-cn'] = "经理语音信箱分机问候语。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Voicemail greeting file encoded in base64.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "以base64编码的语音邮件问候语文件。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "以base64编码的语音邮件问候语文件。";
