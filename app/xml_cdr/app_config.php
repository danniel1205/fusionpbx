...
//		$apps[$x]['description']['en-us'] = "Call Detail Records with all information about the call.";
		$apps[$x]['description']['en-us'] = "呼叫详细信息记录，包括有关呼叫的所有信息。";
		$apps[$x]['description']['zh-cn'] = "呼叫详细信息记录，包括有关呼叫的所有信息。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Indicates if a recording was made. If a recording exists set this value to true.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "指示是否录制。如果存在记录，请将此值设置为“真”。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "指示是否录制。如果存在记录，请将此值设置为“真”。";
		$apps[$x]['db'][$y]['fields'][$z]['deprecated'] = "true";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The 线路 of the call a or b.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "呼叫A或B的线路。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "呼叫A或B的线路。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Post Dial Delay (PDD) in miliseconds. Divide by 1000 for seconds.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "拨号后延迟（PDD），单位为毫秒。除以1000秒。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "拨号后延迟（PDD），单位为毫秒。除以1000秒。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Save the last application in the leg.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "保存线路部的最后一个应用程序。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "保存线路部的最后一个应用程序。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "last_arg";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Save the last application data.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "保存上一个应用程序数据。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "保存上一个应用程序数据。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "cc_side";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Queue side is either member or agent";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "队列端是成员或代理";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "队列端是成员或代理";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Unique member identifier";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "唯一成员标识符";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "唯一成员标识符";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Epoch when caller joined the queue";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "呼叫者加入队列时的epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "呼叫者加入队列时的epoch";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "cc_queue";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Queue";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "排队";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "排队";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Unique session identifier";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "唯一会话标识符";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "唯一会话标识符";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "agent id";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "代理ID";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "代理ID";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "cc_agent";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "agent name";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "代理人姓名";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "代理人姓名";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "cc_agent_type";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "agent type";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "代理类型";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "代理类型";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "cc_agent_bridged";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "bridged true or false";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "桥接的对或错";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "桥接的对或错";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "queue answered epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "队列应答的epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "队列应答的epoch";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "queue terminated epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "队列终止的epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "队列终止的epoch";
		$z++;
...
// 		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "cause";
 		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "原因";
 		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "原因";
 		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "wait seconds";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "等待秒";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "等待秒";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_name";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "conference name";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "会议名称";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "会议名称";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "conference unique identifier";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "会议唯一标识符";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "会议唯一标识符";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_member_id";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "conference member id";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "会议成员ID";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "会议成员ID";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "digits_dialed";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "digits dialed";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "拨出的数字";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "拨出的数字";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "pin_number";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "pin number";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "PIN码";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "PIN码";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Save who hung up or cancelled the leg.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "保留挂断或取消线路的人。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "保留挂断或取消线路的人。";
