...
//		$apps[$x]['description']['en-us'] = "Conferences Centers allows one or more audio and video conference rooms.";
		$apps[$x]['description']['en-us'] = "会议中心允许一个或多个音频和视频会议室。";
		$apps[$x]['description']['zh-cn'] = "会议中心允许一个或多个音频和视频会议室。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the conference center name.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入会议中心名称。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入会议中心名称。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the conference center extension number.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入会议中心分机号码。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入会议中心分机号码。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_center_pin_length";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the pin length.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入PIN长度。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入PIN长度。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_center_greeting";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the conference greeting.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入会议问候语。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入会议问候语。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the center description.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入中心描述。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入中心描述。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enable or disable the conference center.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "启用或禁用会议中心。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "启用或禁用会议中心。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Conference UUID";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "会议UUID";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "会议UUID";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the conference room name.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入会议室名称。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入会议室名称。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "profile";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the conference profile.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择会议配置文件。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择会议配置文件。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select whether to record the conference.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择是否录制会议。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择是否录制会议。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "max_members";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Limit number of people in the conference.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "限制会议中的人数。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "限制会议中的人数。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Open the conference room at the start time.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "开始时打开会议室。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "开始时打开会议室。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "stop_datetime";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Close the conference room at the stop time.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "在停止时间关闭会议室。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "在停止时间关闭会议室。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Wait for the moderator to join before starting the conference.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "在开始会议之前，请等待主持人加入。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "在开始会议之前，请等待主持人加入。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Introduce participants as they enter the conference.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "在与会者进入会议时介绍他们。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "在与会者进入会议时介绍他们。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Play sound when someone enters or exists the conference.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "当有人进入或存在会议时播放声音。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "当有人进入或存在会议时播放声音。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "mute";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Mute participants on entering the conference.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "使与会者进入会议时静音。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "使与会者进入会议时静音。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "created";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Date when the conference was created.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "创建会议的日期。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "创建会议的日期。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "created_by";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The user that created the conference session.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "创建会议会话的用户。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "创建会议会话的用户。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "enabled";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select to enable or disable the session.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择以启用或禁用会话。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择以启用或禁用会话。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "description";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Description.for the conference session.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "说明。用于会议会话。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "说明。用于会议会话。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "meeting_uuid";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "会议室";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "会议室";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "profile";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the conference profile.";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Conference Recording";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "会议记录";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "会议记录";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "start_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "start_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "开始_批次";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "开始_批次";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "end_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "end_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "结束_批次";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "结束_批次";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Extension number.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "分机号码。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "分机号码。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "caller_id_name";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "caller_id_name";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "呼叫者姓名";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "呼叫者姓名";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "caller_id_number";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "caller_id_number";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "呼叫者号码";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "呼叫者号码";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Call UUID";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "呼叫UUID";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "呼叫UUID";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "moderator";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Moderator";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "慢化剂";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "慢化剂";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "network_addr";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "network address";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "网络地址";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "网络地址";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "start_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "start_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "开始新纪元";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "开始新纪元";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "end_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "end_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "世纪末";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "世纪末";
