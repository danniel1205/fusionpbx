...
//		$apps[$x]['description']['en-us'] = "Used to define external destination numbers.";
		$apps[$x]['description']['en-us'] = "用于定义外部目的地编号。";
		$apps[$x]['description']['zh-cn'] = "用于定义外部目的地编号。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Regular Expression version of destination number";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "目标编号的正则表达式版本";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "目标编号的正则表达式版本";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select whether to record the call.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择是否记录呼叫。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择是否记录呼叫。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the application.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入应用程序。";
