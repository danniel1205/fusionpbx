...
//		$apps[$x]['description']['en-us'] = "A tool to call multiple extensions.";
		$apps[$x]['description']['en-us'] = "调用多个扩展的工具。";
		$apps[$x]['description']['zh-cn'] = "调用多个扩展的工具。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the greeting.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择问候语。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择问候语。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "ring_group_context";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the context.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入上下文。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the call forward destination.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入呼叫转移目的地。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入呼叫转移目的地。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select enable or disable the ring group call forward.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择启用或禁用铃声组呼叫转移。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择启用或禁用铃声组呼叫转移。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "ring_group_caller_id_name";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the caller ID name.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入呼叫者ID名称。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入呼叫者ID名称。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "ring_group_caller_id_number";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the caller ID number.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入来电显示号码。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the caller ID name prefix.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入呼叫者ID名称前缀。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入呼叫者ID名称前缀。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the caller ID number prefix.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入来电显示号码前缀。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入来电显示号码前缀。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "ring_group_strategy";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the strategy.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择策略。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择策略。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "ring_group_timeout_app";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the timeout destination.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择超时目标。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择超时目标。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select a sound for distinctive ring.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "为独特的铃声选择一个声音。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "为独特的铃声选择一个声音。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "ring_group_ringback";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the ringback.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择回电铃声。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择回电铃声。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select enable or disable the ring group.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "选择启用或禁用铃声组。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择启用或禁用铃声组。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Toll Allow for Ring Group Forward.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "允许响铃组转发的通行费。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "允许响铃组转发的通行费。";
