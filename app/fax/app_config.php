...
//		$apps[$x]['description']['en-us'] = "To receive a FAX setup a fax extension and then direct the incoming FAX with a dedicated number or you can detect the FAX tone by using on the Public tab.";
		$apps[$x]['description']['en-us'] = "要接收传真，请设置传真分机，然后使用专用号码直接发送传入传真，或者可以通过在“公用”选项卡上使用检测传真音调。";
		$apps[$x]['description']['zh-cn'] = "要接收传真，请设置传真分机，然后使用专用号码直接发送传入传真，或者可以通过在“公用”选项卡上使用检测传真音调。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "IMAP or POP3 connection.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "IMAP或POP3连接。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "IMAP或POP3连接。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "fax_email_connection_host";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Server to connect to.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "要连接的服务器。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "要连接的服务器。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "fax_email_connection_port";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Port to connect to.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "要连接的端口。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "要连接的端口。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enable SSL or TLS encryption.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "启用SSL或TLS加密。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "启用SSL或TLS加密。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Validate certificate or not.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "是否验证证书。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "是否验证证书。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Username for authentication.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "用于身份验证的用户名。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "用于身份验证的用户名。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Password for authentication.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "用于身份验证的密码。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "用于身份验证的密码。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "fax_email_connection_mailbox";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Mailbox folder to monitor.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "要监视的邮箱文件夹。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "要监视的邮箱文件夹。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Subject tag to detect inbound faxes.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "用于检测入站传真的主题标记。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "用于检测入站传真的主题标记。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Subject tag to detect outbound faxes.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "用于检测出站传真的主题标记。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "用于检测出站传真的主题标记。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Authorized email-to-fax sender addresses.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "授权电子邮件传真发件人地址。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "授权电子邮件传真发件人地址。";
		$z++;
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "FAX server primary key";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "传真服务器主键";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "传真服务器主键";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "fax_mode";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "rx / tx  - Rx means receive and Tx means transmit.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Rx/Tx—Rx表示接收，Tx表示发送。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "Rx/Tx—Rx表示接收，Tx表示发送。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "fax_destination";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "tx - fax transmission";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Tx-传真传输";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "Tx-传真传输";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "fax_file_type";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "TIF / PDF";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "tif/pdf格式";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "tif/pdf格式";
		$z++;
