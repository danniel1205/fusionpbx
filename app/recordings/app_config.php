...
//		$apps[$x]['description']['en-us'] = "Manage recordings primarily used with an IVR.";
		$apps[$x]['description']['en-us'] = "管理主要用于IVR的记录。";
		$apps[$x]['description']['zh-cn'] = "管理主要用于IVR的记录。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Recording file encoded in base64.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "以base64编码的录制文件。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "以base64编码的录制文件。";
