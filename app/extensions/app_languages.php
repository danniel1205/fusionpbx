...
$text['label-column_name']['en-us'] = "列名字";
$text['label-column_name']['zh-cn'] = "列名字";
...
$text['description-extension']['en-us'] = "输入字母数字扩展名。默认配置允许2-15位数的扩展";
$text['description-extension']['zh-cn'] = "输入字母数字扩展名。默认配置允许2-15位数的扩展";
