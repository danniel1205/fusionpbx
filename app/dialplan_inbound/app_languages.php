...
$text['title-dialplan-inbound-add']['en-us'] = "入站呼叫路由";
...
$text['option-ani']['en-us'] = "阿尼";
$text['option-ani']['zh-cn'] = "阿尼";
...
$text['label-select-inbound-destination-number']['en-us'] = "选择入站目的地编号。";
$text['label-select-inbound-destination-number']['zh-cn'] = "选择入站目的地编号。";
...
$text['label-required-domain_uuid']['en-us'] = "请提供：域\uuid";
$text['label-required-domain_uuid']['zh-cn'] = "请提供：域\uuid";
...
$text['label-required-condition_field_1']['en-us'] = "请提供：条件字段";
...
$text['label-required-condition_expression_1']['en-us'] = "请提供：条件表达式";
...
$text['label-required-action_application_1']['en-us'] = "请提供：行动申请";
...
$text['label-caller-id-number-prefix']['en-us'] = "主叫号码前缀";
$text['label-caller-id-number-prefix']['zh-cn'] = "主叫号码前缀";
...
$text['label-access-denied']['en-us'] = "拒绝访问";
...
$text['description-caller-id-number-prefix']['en-us'] = "在呼叫者ID号上设置前缀。";
$text['description-caller-id-number-prefix']['zh-cn'] = "在呼叫者ID号上设置前缀。";
...
$text['description-name']['en-us'] = "请输入入站路由名称。";
...
$text['description-dialplan-inbound-add']['en-us'] = "公用拨号计划用于根据一个或多个条件和上下文将传入呼叫路由到目标。它可以向自动助理、HuntGroup、分机、外部号码或脚本发送传入呼叫。";
$text['description-dialplan-inbound-add']['zh-cn'] = "公用拨号计划用于根据一个或多个条件和上下文将传入呼叫路由到目标。它可以向自动助理、HuntGroup、分机、外部号码或脚本发送传入呼叫。";
