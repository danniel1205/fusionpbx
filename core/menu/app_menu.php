<?php
	$y=0;
	$apps[$x]['menu'][$y]['title']['en-us'] = "选单管理员";
	...
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "选单管理员";
	...
	$apps[$x]['menu'][$y]['groups'][] = "superadmin";
	$y++;
	$apps[$x]['menu'][$y]['title']['en-us'] = "状态管理";
	$apps[$x]['menu'][$y]['title']['ar-eg'] = "";
	...
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "状态管理";
