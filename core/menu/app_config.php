...
//		$apps[$x]['description']['en-us'] = "The menu can be customized using this tool.";
		$apps[$x]['description']['en-us'] = "可以使用此工具自定义菜单。";
		$apps[$x]['description']['zh-cn'] = "可以使用此工具自定义菜单。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the name of the menu.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "输入菜单的名称。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入菜单的名称。";
		$z++;
