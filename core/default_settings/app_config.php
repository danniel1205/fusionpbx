...
//		$apps[$x]['description']['en-us'] = "Default settings that apply to all domains.";
		$apps[$x]['description']['en-us'] = "应用于所有域的默认设置。";
		$apps[$x]['description']['zh-cn'] = "应用于所有域的默认设置。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The language name/title.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "语言名称/标题。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "语言名称/标题。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "code";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The language code.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "语言代码。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "语言代码。";
...
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The country name/title.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "国家名称/头衔。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "国家名称/头衔。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "iso_a2";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The 2-letter ISO abbreviation.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "两个字母的ISO缩写。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "两个字母的ISO缩写。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "iso_a3";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The 3-letter ISO abbreviation.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "三个字母的ISO缩写。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "三个字母的ISO缩写。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "num";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The numerical code.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "数字代码。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "数字代码。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "calling_code";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
//		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The calling code.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "呼叫代码。";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "呼叫代码。";
